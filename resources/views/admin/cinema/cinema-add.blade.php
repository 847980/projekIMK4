            ...
            <div class="container container-sm">
                <form action="{{ route('admin.cinema.store') }}" method="post"  enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <input name="name" id="name" class="input form-control @error('name') is-invalid  @enderror" type="text" value="{{ old('name') }}" placeholder="nama cinema">
                            @error('name')
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <input name="address" id="address" class="input form-control @error('address') is-invalid  @enderror" type="text" value="{{ old('address') }}" placeholder="alamat cinema">
                            @error('address')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
