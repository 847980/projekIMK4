        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide container">
                ...
                <div class="home-text">
                    ...
                    <a href="https://youtu.be/bD7bpG-zDJQ?si=ab3C2pS0hBNuPGH_" class="btn btn-primary"><i class='bx bx-play'></i></a>
                </div>
            </div>
            <div class="swiper-slide container">
                ...
                <div class="home-text">
                    ...
                    <h1>Avatar</h1>
                    <a href="/booking" class="btn">BOOK NOW</a>
                    <a href="https://youtu.be/5PSNL1qE6VY?si=x2aIZjZ-rwnZYqCp" class="btn btn-primary"><i class='bx bx-play'></i></a>
                </div>
            </div>
            <div class="swiper-slide container">
                ...
                <div class="home-text">
                    ...
                    <h1>Spirited Away</h1>
                    <a href="/booking" class="btn">BOOK NOW</a>
                    <a href="https://youtu.be/ByXuk9QqQkk?si=qYtpG3GYmT0xUZ_2" class="btn btn-primary"><i class='bx bx-play'></i></a>
                </div>
            </div>
        </div>
    ...
    <div class="flex-container">
        <div class="wrapper">
            <div class="select-btn">
                <span>Surabaya</span><i class='bx bx-chevron-down'></i>
            </div>
            <div class="content">
                <div class="search">
        ...
        <div class="wrapper">
            <div class="select-btn">
                <span>Cinema 1</span><i class='bx bx-chevron-down'></i>
            </div>
            <div class="content">
                <div class="search">
                    <i class='bx bx-search'></i>
